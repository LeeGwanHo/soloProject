...
<html>
	<head>
		<meta charset="utf-8">
		<title>관호 페이지</title>
		<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER["HTTP_HOST"]?>/lkhtest/solopage/css/style.css?after4">
		<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER["HTTP_HOST"]?>/lkhtest/solopage/member/css/member.css">
