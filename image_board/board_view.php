...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/lkhtest/solopage/image_board/css/board.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/lkhtest/solopage/image_board/js/board.js"></script>
		<script src="http://<?= $_SERVER["HTTP_HOST"] ?>/lkhtest/solopage/js/common.js" defer></script>
