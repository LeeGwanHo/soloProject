<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/lkhtest/solopage/free/lib/free_func.php";
...
<html lang="ko" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/lkhtest/solopage/free/css/greet.css">
	...
	<body onload="slide_func()">
		...
		<section>
			...
			");
                ...
                include $_SERVER['DOCUMENT_ROOT'] . "/lkhtest/solopage/main_bar.php"; ?>
			<div id="wrap">
				<div id="content">
					<div id="col2">
