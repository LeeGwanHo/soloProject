...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER["HTTP_HOST"]?>/lkhtest/solopage/memo/css/message.css?after5">
		<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
		<script src="js/message.js"></script>
		<script src="http://<?=$_SERVER['HTTP_HOST'];?>/lkhtest/solopage/js/slide.js"></script>
	</head>
